...
<p align="center">
  <sub>
    日本語ローカライゼーション・フォーク by <a href="https://github.com/kazumasakawahara">Kazumasa Kawahara</a> ・
    本家: <a href="https://github.com/nashsu/llm_wiki">nashsu/llm_wiki</a> by Yong Su (GPL v3)
  </sub>
</p>
...
本実装は **Yong Su** 氏による [nashsu/llm_wiki](https://github.com/nashsu/llm_wiki) を基礎としている。Yong Su 氏が Karpathy 氏のパターンを Tauri ベースのデスクトップアプリケーションとして実装し、知識グラフ、Louvain コミュニティ検出、Deep Research、Chrome 拡張など多数の拡張を加えたものである。本リポジトリ ([kazumasakawahara/ja-llm-wiki](https://github.com/kazumasakawahara/ja-llm-wiki)) はそれをフォークし、日本語 UI、日本語形態素解析、日本語テンプレート、日本語向けドキュメントを追加した派生版である。ライセンスは原作と同じ **GPL v3**。
...
> 本家英語版は [nashsu/llm_wiki](https://github.com/nashsu/llm_wiki) を参照。

日本語版は [Releases](https://github.com/kazumasakawahara/ja-llm-wiki/releases) からダウンロードできる。
...
<sub>(本家リポジトリ [nashsu/llm_wiki](https://github.com/nashsu/llm_wiki) のスター履歴)</sub>
